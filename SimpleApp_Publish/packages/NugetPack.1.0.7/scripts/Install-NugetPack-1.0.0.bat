...
REM    * 									 *
REM    * 	Installs BTDF MSI Package (Including Framework Components)	 *
REM    * 									 *
REM    * 									 *
...
SET LOG_FILE=NugetPack-1.0.0.Install.log
...
start "" msiexec.exe /i NugetPack-1.0.0.msi /passive /log %LOG_FILE% INSTALLDIR=%INSTALL_DIR%
